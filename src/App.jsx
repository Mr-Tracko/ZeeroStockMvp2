...
import ManageListingPage from './pages/seller/ManageListingPage';
...
import SearchInventoryPage from './pages/buyer/SearchInventoryPage';
      ...
      <div className="min-h-screen flex flex-col font-sans">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/seller/listNewItemPage" element={<ListNewItemPage />} />
            <Route path="/seller/manage-listings" element={<ManageListingPage />} />
