...
const BuyerDashboardPage = () => {
  ...
  const dashboardStats = [
    { title: 'Total Orders', value: '24', icon: <ShoppingCart className="h-5 w-5 text-blue-500" />, change: '+5 since last month' },
    { title: 'Total Spent', value: '₹45,230', icon: <DollarSign className="h-5 w-5 text-green-500" />, change: '+10% since last month' },
    { title: 'Watchlist Items', value: '12', icon: <Eye className="h-5 w-5 text-purple-500" />, change: '+2 new' },
    { title: 'Saved Searches', value: '8', icon: <Search className="h-5 w-5 text-yellow-500" />, change: 'Updated recently' },
  ];
  ...
  {/* <BuyerSidebar activeRoute="/buyer-Dashboard" /> */ }
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 p-6 space-y-8">
        ...
        {/* KYC Status */}
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-md flex justify-between items-center">
          <span><span className="font-semibold">KYC Status: Verified</span>: Your account is fully verified and ready for trading</span>
          <CheckCircle className="h-5 w-5" />
        </div>
