  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex">
      ...
      <div className="w-64 mr-6">
        <BuyerSidebar activeRoute="/buyer/my-orders" />
      </div>
              ...
              <TableBody>
                {orders.map((order) => (
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      <span
                        className={`flex items-center px-2 py-1 rounded-full text-xs font-semibold ${order.status === 'Completed'
                      ...
                      {order.trackingId &&
                        ...
                        order.status !== 'Cancelled' && (
                          <Button
                            ...
                            className="ml-2"
                            onClick={() =>
                              console.log('Track Order', order.trackingId)
                            }
                          >
                            Track
                          </Button>
