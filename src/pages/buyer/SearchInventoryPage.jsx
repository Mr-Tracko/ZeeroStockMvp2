...
const SearchInventoryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      {/* Flex container to place sidebar and content side by side */}
      <div className="flex">

        {/* Sidebar section */}
        <div className="w-1/5">
          <BuyerSidebar activeRoute="/buyer/search-inventory" />
        </div>

        {/* Main content section */}
        <div className="w-4/5 pl-6 space-y-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Select>
                  ...
                  <SelectContent>
                    {conditions.map(cond => (
                      <SelectItem key={cond} value={cond.toLowerCase().replace(/\s/g, '-')}>{cond}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
                ...
                <Select>
                  ...
                  <SelectContent>
                    {regions.map(reg => (
                      <SelectItem key={reg} value={reg.toLowerCase().replace(/\s/g, '-')}>{reg}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
