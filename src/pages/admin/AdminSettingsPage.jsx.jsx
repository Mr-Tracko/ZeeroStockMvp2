...
const AdminSettingsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex">
      ...
      <div className="flex-1 max-w-7xl mx-auto pl-6 space-y-8">
        <Card className="p-6 rounded-lg shadow-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-2xl font-bold text-gray-900 flex items-center">
              <Settings className="h-6 w-6 mr-2" /> System Settings
          ...
          <CardContent>
            ...
            {/* Category Management */}
            <h3 className="text-xl font-semibold text-gray-800 flex items-center mb-4">
              <List className="h-5 w-5 mr-2" /> Category Management
            </h3>
            <div className="space-y-6 mb-8">
              {/* Add New Category */}
              <div className="flex items-end gap-4">
            ...
            {/* Fee Structures */}
            <h3 className="text-xl font-semibold text-gray-800 flex items-center mb-4">
              <DollarSign className="h-5 w-5 mr-2" /> Fee Structures
            </h3>
            <div className="space-y-4 mb-8">
              <div className="space-y-2">
                <Label htmlFor="commissionRate">Commission Rate (%)</Label>
            ...
            {/* Notification Templates */}
            <h3 className="text-xl font-semibold text-gray-800 flex items-center mb-4">
              <Bell className="h-5 w-5 mr-2" /> Notification Templates
            </h3>
            <div className="space-y-4 mb-8">
              <div className="space-y-2">
                <Label htmlFor="newOfferEmailSubject">New Offer Email Subject</Label>
