...
//       <AdminSidebar activeRoute="/admin/listings" />
...
import { Badge } from '../../components/ui/badge';
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from '../../components/ui/dropdown-menu';
import { Search, Filter, MoreHorizontal, Eye, Edit, Trash2, CheckCircle, XCircle, Clock, List } from 'lucide-react'; // Added List icon
import AdminSidebar from './AdminSidebar'; // Commented out - you'll need to create this component
...
const AdminListingsPage = () => {
  ...
  const getListingStatusBadgeVariant = (status) => {
    switch (status) {
      ...
      case 'Pending Review': return 'secondary'; // Changed from 'yellow' to 'secondary'
      default: return 'secondary';
    }
  };
  ...
  const getReviewStatusBadgeVariant = (status) => {
    switch (status) {
      case 'Approved': return 'default'; // Changed from 'green' to 'default'
      case 'Pending': return 'secondary'; // Changed from 'yellow' to 'secondary'
      case 'Rejected': return 'destructive'; // Changed from 'red' to 'destructive'
      default: return 'secondary';
    }
  };
