...
import { Button } from '../../components/ui/button';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '../../components/ui/table';
import { Separator } from '../../components/ui/separator'; // Added missing Separator import
        ...
        <Card className="p-6 rounded-lg shadow-sm">
          ...
          <CardContent>
            ...
            <h3 className="text-xl font-semibold text-gray-800 flex items-center mb-4">
              <TrendingUp className="h-5 w-5 mr-2" /> Platform Performance
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <Card className="rounded-lg shadow-sm">
                <CardHeader className="pb-2">
            ...
            {/* Financial Reports */}
            <h3 className="text-xl font-semibold text-gray-800 flex items-center mb-4">
              <DollarSign className="h-5 w-5 mr-2" /> Financial Reports
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <Card className="rounded-lg shadow-sm">
                <CardHeader className="pb-2">
            ...
            {/* Market Insights */}
            <h3 className="text-xl font-semibold text-gray-800 flex items-center mb-4">
              <PieChart className="h-5 w-5 mr-2" /> Market Insights
            </h3>
            <Card className="p-6 rounded-lg shadow-sm mb-8">
              <CardTitle className="text-lg font-semibold text-gray-900 mb-4">Top Categories by Sales Volume</CardTitle>
              <Table>
            ...
            {/* User Activity Logs */}
            <h3 className="text-xl font-semibold text-gray-800 flex items-center mb-4">
              <Activity className="h-5 w-5 mr-2" /> Recent User Activity Logs
            </h3>
            <Card className="p-6 rounded-lg shadow-sm">
              <CardTitle className="text-lg font-semibold text-gray-900 mb-4">Recent Activity</CardTitle>
              <div className="max-h-80 overflow-y-auto">
